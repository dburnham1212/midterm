...
const { users, quizzes, questions, answers, results, generateRandomString, getUserByEmail, getUserById, getEntireQuiz, getQuizByQuizId, getQuestionsByQuizId, getAnswersByQuizId } = require("../database_placeholders/users");
